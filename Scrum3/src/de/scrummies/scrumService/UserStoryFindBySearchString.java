...
@XmlRootElement(name = "UserStoryFindBySearchString")
public class UserStoryFindBySearchString {

    protected String sessionToken;
    @XmlElementRef(name = "searchString", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
